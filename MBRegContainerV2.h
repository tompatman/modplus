...
#include "modbus/MBReg.h"
#include <Poco/NumberFormatter.h>
#include <vector>
#include <modbus/modbus.h>
#include "core/ppcLogger.h"
#include <type_traits>
#include <core/IEnumPrinter.h>
...
template<typename ModbusEnumId>
class MBRegContainerV2 {
public:
    MBRegContainerV2(const Poco::UInt32 anaReadStartAdd, const Poco::UInt32 numAnaReadAddresses, const Poco::UInt32 anaRWStartAdd, const Poco::UInt32 numAnaRWAddresses,
                     ...
                     const Poco::UInt64 numRegIds, PbPoco::Core::IEnumPrinter<ModbusEnumId> &enumPrint)
              ...
              , _enumPrint(enumPrint)
    {
      ...
      _log.log(LG_INFO, "Creating Modbus V2 register container");
    ...
    char *getMBDataPointer(const PbModbus::RegGroup::eRegGroup type, const Poco::UInt32 regAddress)
    {
      ...
      switch (type)
      {
        case PbModbus::RegGroup::DigitalR: numRegisters = _mbMapping->nb_input_bits;
          break;
        case PbModbus::RegGroup::DigitalRW: numRegisters = _mbMapping->nb_bits;
          break;
        case PbModbus::RegGroup::AnalogR: numRegisters = _mbMapping->nb_input_registers;
          break;
        case PbModbus::RegGroup::AnalogRW: numRegisters = _mbMapping->nb_registers;
          break;
        default:throw Poco::InvalidArgumentException("Invalid register group");
      }
    ...
    void addUInt8(const ModbusEnumId regID, const Poco::UInt64 uiRegAddress, Poco::UInt8 defaultValue, const PbModbus::RegGroup::eRegGroup groupType = PbModbus::RegGroup::AnalogRW)
    {
      ...
      regUI8[regID] = std::unique_ptr<PbModbus::MBReg<ModbusEnumId, Poco::UInt8> >(
              new PbModbus::MBReg<ModbusEnumId, Poco::UInt8>(regID, uiRegAddress, (Poco::UInt8 *) getMBDataPointer(groupType, uiRegAddress),
                                                             _mut, defaultValue));
    };

    void addUInt16(const ModbusEnumId regID, const Poco::UInt64 uiRegAddress, Poco::UInt16 defaultValue, const PbModbus::RegGroup::eRegGroup groupType = PbModbus::RegGroup::AnalogRW)
    {
      validateRegIdForAdd(regID);
      ...
      regUI16[regID] = std::unique_ptr<PbModbus::MBReg<ModbusEnumId, Poco::UInt16> >(
              new PbModbus::MBReg<ModbusEnumId, Poco::UInt16>(regID, uiRegAddress, (Poco::UInt16 *) getMBDataPointer(groupType, uiRegAddress),
                                                              _mut, defaultValue));
    };

    void addUInt16(Poco::UInt16 ui16Default, std::unique_ptr<PbModbus::MBReg<ModbusEnumId, Poco::UInt16>> newReg)
    {
    ...
    void
    addUInt32(const ModbusEnumId regID, const Poco::UInt64 uiRegAddress, Poco::UInt32 defaultValue, const PbModbus::RegGroup::eRegGroup groupType = PbModbus::RegGroup::AnalogRW)
    {
      validateRegIdForAdd(regID);
      ...
      regUI32[regID] = std::unique_ptr<PbModbus::MBReg<ModbusEnumId, Poco::UInt32> >(
              new PbModbus::MBReg<ModbusEnumId, Poco::UInt32>(regID, uiRegAddress, (Poco::UInt32 *) getMBDataPointer(groupType, uiRegAddress),
                                                              _mut, defaultValue));
    };

    void addUInt32(Poco::UInt32 ui32Default, std::unique_ptr<PbModbus::MBReg<ModbusEnumId, Poco::UInt32>> newReg)
    {
      validateRegIdForAdd(newReg->getRegID());
    ...
    void
    addUInt64(const ModbusEnumId regID, const Poco::UInt64 uiRegAddress, Poco::UInt64 defaultValue, const PbModbus::RegGroup::eRegGroup groupType = PbModbus::RegGroup::AnalogRW)
    {
      validateRegIdForAdd(regID);
      ...
      regUI64[regID] = std::unique_ptr<PbModbus::MBReg<ModbusEnumId, Poco::UInt64> >(
              new PbModbus::MBReg<ModbusEnumId, Poco::UInt64>(regID, uiRegAddress, (Poco::UInt64 *) getMBDataPointer(groupType, uiRegAddress),
                                                              _mut, defaultValue));
    };
     ...
     * @param groupType
     */
    void addFloatSingle(const ModbusEnumId regID, const Poco::UInt64 uiRegAddress, float defaultValue, const PbModbus::RegGroup::eRegGroup groupType = PbModbus::RegGroup::AnalogRW)
    {
      validateRegIdForAdd(regID);
      ...
      regFloat[regID] = std::unique_ptr<PbModbus::MBReg<ModbusEnumId, float> >(
              new PbModbus::MBReg<ModbusEnumId, float>(regID, uiRegAddress, (float *) getMBDataPointer(groupType, uiRegAddress),
                                                       _mut, uiDefault));
    };

    void addString(const ModbusEnumId regID, const Poco::UInt64 uiRegAddress, const std::string strDefault)
    {
      PbModbus::tString tstrDefault;
      ...
      regStr[regID] = std::unique_ptr<PbModbus::MBReg<ModbusEnumId, PbModbus::tString> >(
              new PbModbus::MBReg<ModbusEnumId, PbModbus::tString>(regID, uiRegAddress,
                                                                   (PbModbus::tString *) getMBDataPointer(PbModbus::RegGroup::AnalogRW, uiRegAddress), _mut, tstrDefault));
    ...
    PbModbus::MBReg<ModbusEnumId, Poco::UInt8> &getReg8(const ModbusEnumId regEnum, const bool bThrow = false)
    {
    ...
    //If bThrow is true an exception will be thrown instead of returning nullptr
    PbModbus::MBReg<ModbusEnumId, Poco::UInt16> &getReg16(const ModbusEnumId regEnum)
    {
    ...
    PbModbus::MBReg<ModbusEnumId, Poco::UInt32> &getReg32(const ModbusEnumId regEnum)
    {
    ...
    PbModbus::MBReg<ModbusEnumId, Poco::UInt64> &getReg64(const ModbusEnumId regEnum)
    {
    ...
    PbModbus::MBReg<ModbusEnumId, float> &getRegFloat(const ModbusEnumId regEnum)
    {
    ...
    PbModbus::MBReg<ModbusEnumId, PbModbus::tString> & getRegStr(const ModbusEnumId regEnum, const bool bThrow = false)
    {
    ...
    void getRegStrRef(const ModbusEnumId regEnum, PbModbus::tString &refVal)
    {
      auto mbReg = regStr.find(regEnum);
      if (mbReg == regStr.end()) throw Poco::InvalidAccessException("Invalid register ID " + Poco::NumberFormatter::format(regEnum) + " for regStr");
    ...
    std::map<ModbusEnumId, std::unique_ptr<PbModbus::MBReg<ModbusEnumId, Poco::UInt8> > > regUI8;
    std::map<ModbusEnumId, std::unique_ptr<PbModbus::MBReg<ModbusEnumId, Poco::UInt16> > > regUI16;
    std::map<ModbusEnumId, std::unique_ptr<PbModbus::MBReg<ModbusEnumId, Poco::UInt32> > > regUI32;
    std::map<ModbusEnumId, std::unique_ptr<PbModbus::MBReg<ModbusEnumId, Poco::UInt64> > > regUI64;
    std::map<ModbusEnumId, std::unique_ptr<PbModbus::MBReg<ModbusEnumId, float> > > regFloat;
    std::map<ModbusEnumId, std::unique_ptr<PbModbus::MBReg<ModbusEnumId, PbModbus::tString> > > regStr;
...
private:
    ...
    PbPoco::Core::IEnumPrinter<ModbusEnumId> &_enumPrint;

public:
    PbPoco::Core::IEnumPrinter<ModbusEnumId> &getEnumPrinter() const
    {
      return _enumPrint;
    }
...
private:
    ...
    void validateRegIdForAdd(const ModbusEnumId regID)
    {
      ...
      {
        _log.log(LG_NOTICE, "New register id " + Poco::NumberFormatter::format(regID) + " is not in order.");
      }
      _lastAddedId = regID;
